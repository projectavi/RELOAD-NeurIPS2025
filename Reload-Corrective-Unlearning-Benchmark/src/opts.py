...
def parse_args():
    ...
    parser.add_argument('--dataset_method', type=str, default='randomlabelswap', choices=['randomlabelswap', 'interclasslabelswap', 'poisoning', 'poison'], help='Number of Classes')
    parser.add_argument('--unlearn_method', type=str, default='Naive', choices=['Naive', 'EU', 'CF', 'Scrub', 'BadT', 'SSD', 'Reload'], help='Method for unlearning')
    ...
    # Reload Specific Params
    parser.add_argument('--alr', type=float, default=0.01, help='learning rate for gradient ascent')
    parser.add_argument('--rlr', type=float, default=0.01, help='number of steps for repair finetuning')
    parser.add_argument('--threshold', type=float, default=0.1, help='threshold for parameter reset')
    parser.add_argument('--replacement_strategy', type=str, default='zero', help='replacement strategy for parameter reset')
    parser.add_argument('--repair_epochs', type=int, default=5, help='epochs for repair finetuning')
